...
dataset = pd.read_csv('datasets/car/train.csv', names= ['buying', 'maint', 'doors', 'persons', 'lug_boot', 'safety','label'])

X =  dataset.iloc[:, : - 1].values()
labels = dataset.iloc[:,-1]
decisionTree = DecisionTreeClassifier( X , ['buying', 'maint', 'doors', 'persons', 'lug_boot', 'safety'], labels)
decisionTree.id3()